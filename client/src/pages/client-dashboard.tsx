...
const statusConfig: Record<string, { color: string; icon: typeof Clock; label: string }> = {
  draft: { color: "bg-orange-500/10 text-orange-600", icon: Pencil, label: "Utkast" },
  open: { color: "bg-blue-500/10 text-blue-600", icon: Clock, label: "Öppet" },
  reviewing: { color: "bg-yellow-500/10 text-yellow-600", icon: AlertCircle, label: "Granskas" },
  matched: { color: "bg-green-500/10 text-green-600", icon: CheckCircle, label: "Matchat" },
