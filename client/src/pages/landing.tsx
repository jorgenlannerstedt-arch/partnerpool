...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#f3f4f8]">
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="max-w-3xl text-left space-y-8">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-serif font-normal leading-[1.85] tracking-tight" data-testid="text-hero-heading">
              Hitta rätt juridisk <br />partner för ditt ärende2
            </h1>
            ...
            <div className="flex flex-wrap items-center justify-start gap-6 pt-4 text-sm text-foreground/80">
              ...
              <span className="flex items-center gap-1.5">
                <img src="/icon-ai-matching.svg" className="h-5 w-5" alt="" />
                AI-driven matchning
              </span>
              <span className="flex items-center gap-1.5">
      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden" style={{backgroundImage: "url('/dude-front.webp')", backgroundSize: "cover", backgroundPosition: "center"}}>
        <div className="absolute inset-0 bg-white/60" />
        <div className="max-w-7xl mx-auto relative text-left space-y-8">
