...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#f3f4f8]">
      ...
      <section className="relative pt-32 pb-28 px-4 sm:px-6 lg:px-8 overflow-hidden" style={{backgroundImage: "url('/dude2.webp')", backgroundSize: "cover", backgroundPosition: "center"}}>
